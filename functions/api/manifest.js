export async function onRequest(context) {
  ...
  const BRANCH = "main"
  const upstreamUrl =
    `https://raw.githubusercontent.com/amram313/otzaria-library/refs/heads/${BRANCH}/files_manifest.json`
  ...
  resp.headers.set("Cache-Control", "public, max-age=21600") // 6 שעות
