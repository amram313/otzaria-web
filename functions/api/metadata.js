export async function onRequest(context) {
  ...
  const upstreamUrl =
    `https://raw.githubusercontent.com/${OWNER}/${REPO}/refs/heads/${BRANCH}/metadata.json`

  // Cache key includes the upstream URL so changing OWNER/REPO/BRANCH won't reuse stale cached content.
